					...
					<div class="col-md-4">
						<aside>
							<div class="list-group">
								<a href="AssurancesUser.php" class="list-group-item active disabled">Mes Assurances</a>
								<a href="BoursesUser.php"  class="list-group-item">Mes Bourses</a>
								<a href="IdeesUser.php"  class="list-group-item">Mes Idées</a>
								<a href="ReclamationAssurances.php"  class="list-group-item">Mes Reclamations(Assurances)</a>
								<a href="ReclamationBourses.php"  class="list-group-item">Mes Reclamations(Bourses)</a>
								<a href="ReclamationIdees.php"  class="list-group-item">Mes Reclamations(Idées)</a>
