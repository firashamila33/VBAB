					...
					<div class="col-md-4">
						<aside>
							<div class="list-group">
								<a href="AssurancesUser.php" class="list-group-item ">Mes Assurances</a>
								<a href="BoursesUser.php"  class="list-group-item active disabled">Mes Bourses</a>
								<a href="IdeesUser.php"  class="list-group-item">Mes Idées</a>
								<a href="ReclamationsAssurancesUser.php"  class="list-group-item">Mes Reclamations(Assurances)</a>
								<a href="ReclamationsBoursesUser.php"  class="list-group-item">Mes Reclamations(Bourses)</a>
								<a href="ReclamationsIdeesUser.php"  class="list-group-item">Mes Reclamations(Idées)</a>
