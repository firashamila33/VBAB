...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 11 Janvier 2018 à 23:23
...
(5, 2, 'qsdqsdqsd', 'qdsgqdfghq', 'qfdhqdf', '2018-01-13', 1, NULL, NULL, NULL),
(6, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
--
-- Structure de la table `reclamationsidees`
--
...
--
-- Contenu de la table `reclamationsidees`
--
...
(1, 'ADMIN', 'selim.loued@esprit.tn', '123', '2017-12-13', 'Admin', '', '', 0, '', '0000-00-00', 'Admin'),
...
--
-- Index pour la table `reclamationsidees`
--
...
--
-- AUTO_INCREMENT pour la table `reclamationsidees`
--
ALTER TABLE `reclamationsidees`
...
--
ALTER TABLE `idee`
  ADD CONSTRAINT `userID` FOREIGN KEY (`user_id`) REFERENCES `user` (`id_user`);

--
-- Contraintes pour la table `reclamationsidees`
--
ALTER TABLE `reclamationsidees`
